...
new Common().selectPackage(GlobalVariable.Ultimate)
String shahidPrice = WebUI.getText(findTestObject('Object Repository/Evergent/shahidUltimatePrice')).split(' /')[0]
...
String sheetName = new Common().createSheet(GlobalVariable.JOD, GlobalVariable.Ultimate)
