...
String shahidPrice = WebUI.getText(findTestObject('Object Repository/Evergent/shahidVIPPrice')).split(' /')[0]
...
String sheetName = new Common().createSheet(GlobalVariable.JOD, GlobalVariable.VIP)
...
//Check Product Name
if (evergentPackage.trim().equals(productName.substring(0, productName.length() - 1).trim())) {
...
println "productNameFlag:: "+productNameFlag+"skuFlag:: "+skuFlag+"priceFlag:: "+priceFlag

//if(priceFlag&&productNameFlag&&skuFlag) {
//	println "inside if flag"
